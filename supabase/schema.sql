...
-- Includes: profiles(auth linkage), users compatibility view, admin_config, leaderboard, pipeline_logs, games_metadata
...
grant all privileges on public.profiles, public.admin_config, public.pipeline_logs, public.games_metadata, public.leaderboard to service_role;
