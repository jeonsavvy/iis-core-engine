...
def build_genre_brief(*, user_prompt: str, genre_hint: str = "") -> dict[str, Any]:
    ...
    if any(token in text for token in ("프로펠러", "섬", "island", "coast", "비행기", "비행", "플라이트", "flight game", "하늘", "low-poly", "low poly", "링", "ring")):
        ...
        return {
            ...
            "must_have_mechanics": ["pitch", "yaw", "bank", "throttle", "stabilize", "ring collect", "reset"],
            "structural_contracts": [
                ...
                "ring chain and section progression must remain readable in the hud",
                "flight rating or medal loop must persist through the run",
                "flight baseline must prioritize stable traversal over combat",
                "yaw authority, auto-level assist, and altitude recovery must remain active",
            ],
            "visual_contracts": [
            ...
            "must_not_degrade_into": ["dark empty void flight", "space dogfight", "corridor flyer", "wobble-only flight toy"],
            "scaffold_key": scaffold_key,
            ...
            "degradation_guard": ["dark empty void flight", "space dogfight", "corridor flyer", "wobble-only flight toy"],
            "first_frame_requirements": [
    ...
    if any(token in text for token in ("top-down", "topdown", "탑뷰", "twin-stick", "twinstick", "아레나 슈터")):
        ...
        return {
            ...
            "fantasy": "low-poly tactical topdown shooter with readable combat feedback",
            "camera_style": "top_down_arena",
            "progression": ["waves", "mobility mastery", "kill-fed xp choices"],
            ...
            "structural_contracts": [
                ...
                "dash feedback and natural burst movement must remain intact",
                "dash must not clip through cover or arena boundaries",
                "enemy defeats must feed visible kill-fed xp or upgrade flow",
                "upgrade choice must pause combat until the player picks one",
                "cover landmarks and combat spacing must remain readable and solid",
            ...
            "visual_contracts": [
                ...
                "cover blocks, floor contrast, and projectiles must remain visually separated",
            ...
            "scaffold_key": scaffold_key,
            "asset_pack_key": "topdown_lowpoly_pack_v1",
            "quality_target": "web_tactical_twinstick",
            ...
            "first_frame_requirements": [
                ...
                "wave pressure state",
                "cover landmarks and tactical spacing visible immediately",
            ],
        }
