        ...
        *,
        ...
        if is_modification:
            return (
                ...
                "- Preserve existing data-iis presentation markers such as data-iis-title-screen / data-iis-start-button / data-iis-restart-button / data-iis-countdown / data-iis-game-over\n"
                "- Restart/reset flows must restore HP/shield/wave/position into a valid opening state; never restart with 0 HP or 0 shield\n"
        ...
        if scaffold is not None:
            ...
            return (
                ...
                "- Preserve scaffold data-iis presentation markers for title screen / start button / restart button / countdown / game-over overlays\n"
                "- Restart/reset flows must restore HP/shield/wave/position into a valid opening state; never restart with 0 HP or 0 shield\n"
