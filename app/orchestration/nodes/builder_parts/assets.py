    ...
    *,
    ...
    svg_map = {
        "player.svg": (
            f"<svg xmlns='http://www.w3.org/2000/svg' width='128' height='128' viewBox='0 0 128 128'>"
            f"<defs>"
            f"<linearGradient id='runnerPlayerBody' x1='0' y1='0' x2='0' y2='1'>"
            f"<stop offset='0%' stop-color='{player_primary}'/>"
            f"<stop offset='100%' stop-color='{player_secondary}'/>"
            f"</linearGradient>"
            f"<radialGradient id='runnerPlayerCore' cx='50%' cy='30%' r='55%'>"
            f"<stop offset='0%' stop-color='{hud_primary}' stop-opacity='0.95'/>"
            f"<stop offset='100%' stop-color='{boost_color}' stop-opacity='0.22'/>"
            f"</radialGradient>"
            f"</defs>"
            f"<rect width='128' height='128' fill='none'/>"
            f"<path d='M64 8 L108 58 L90 58 L82 114 L46 114 L38 58 L20 58 Z' fill='url(#runnerPlayerBody)'/>"
            f"<path d='M64 20 L84 58 L64 98 L44 58 Z' fill='url(#runnerPlayerCore)'/>"
            f"<rect x='56' y='36' width='16' height='38' rx='5' fill='{player_secondary}'/>"
            f"<path d='M38 58 L24 84 L42 88 L50 62 Z' fill='{player_primary}'/>"
            f"<path d='M90 58 L104 84 L86 88 L78 62 Z' fill='{player_primary}'/>"
            f"</svg>"
        ),
        "enemy.svg": (
            f"<svg xmlns='http://www.w3.org/2000/svg' width='128' height='128' viewBox='0 0 128 128'>"
            f"<defs>"
            f"<linearGradient id='runnerEnemyBody' x1='0' y1='0' x2='0' y2='1'>"
            f"<stop offset='0%' stop-color='{enemy_primary}'/>"
            f"<stop offset='100%' stop-color='{enemy_elite}'/>"
            f"</linearGradient>"
            f"</defs>"
            f"<rect width='128' height='128' fill='none'/>"
            f"<path d='M64 10 L108 48 L98 108 L30 108 L20 48 Z' fill='url(#runnerEnemyBody)'/>"
            f"<rect x='40' y='34' width='48' height='22' rx='7' fill='{player_secondary}'/>"
            f"<rect x='46' y='40' width='14' height='8' rx='3' fill='{hud_primary}' opacity='0.85'/>"
            f"<rect x='68' y='40' width='14' height='8' rx='3' fill='{hud_primary}' opacity='0.85'/>"
            f"<path d='M30 88 L18 112 L38 112 L46 92 Z' fill='{enemy_primary}'/>"
            f"<path d='M98 88 L110 112 L90 112 L82 92 Z' fill='{enemy_primary}'/>"
            f"</svg>"
        ),
        "elite.svg": (
            f"<svg xmlns='http://www.w3.org/2000/svg' width='128' height='128' viewBox='0 0 128 128'>"
            f"<defs>"
            f"<radialGradient id='runnerEliteBody' cx='50%' cy='26%' r='68%'>"
            f"<stop offset='0%' stop-color='{enemy_elite}'/>"
            f"<stop offset='100%' stop-color='{enemy_primary}'/>"
            f"</radialGradient>"
            f"</defs>"
            f"<rect width='128' height='128' fill='none'/>"
            f"<path d='M64 6 L116 40 L102 112 L26 112 L12 40 Z' fill='url(#runnerEliteBody)'/>"
            f"<polygon points='36,32 50,14 60,34' fill='{enemy_elite}'/>"
            f"<polygon points='92,32 78,14 68,34' fill='{enemy_elite}'/>"
            f"<rect x='42' y='38' width='44' height='22' rx='7' fill='{player_secondary}'/>"
            f"<circle cx='54' cy='49' r='5' fill='{hud_primary}'/>"
            f"<circle cx='74' cy='49' r='5' fill='{hud_primary}'/>"
            f"<path d='M46 72 L64 98 L82 72' fill='none' stroke='{hud_primary}' stroke-width='6' stroke-linecap='round'/>"
            f"</svg>"
        ),
        "boost.svg": (
