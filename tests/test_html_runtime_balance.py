...
def test_runtime_balance_block_contains_required_js_symbols() -> None:
    ...
    assert "const CONTROL = CONTROL_PRESETS[CONFIG.mode] || CONTROL_PRESETS.comic_action_brawler_3d || CONTROL_PRESETS.arcade_generic;" in block
    assert "const ACTIVE_DEPTH_PACK = DEPTH_PACKS[CONFIG.mode] || DEPTH_PACKS.comic_action_brawler_3d || DEPTH_PACKS.arcade_generic;" in block
